...
AccountInfo::AccountInfo(string pathPrefix = "")
{
    app_key_ = "";
    developer_key_ = "";
    cloud_url_ = "";
	...
	test_data_input_path_ = path_prefix + "testdata/InPutData/";
	test_data_output_path_ = path_prefix + "testdata/OutPutData/";
	data_path_ = path_prefix + "data/";
	auth_path_ = path_prefix + "auth/";
	logfile_path_ = path_prefix + "Log/";
}
...
string AccountInfo::test_data_input_path()
{
    return test_data_output_path_;
}
string AccountInfo::test_data_output_path()
{
	return test_data_input_path_;
}
